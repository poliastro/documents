...
\usepackage{microtype} % Slightly tweak font spacing for aesthetics\usepackage[english]{babel} % Language hyphenation and typographical rules
...
\fancyhead[C]{poliastro proposal for NumFocus Small Development Grant} % Custom header text
